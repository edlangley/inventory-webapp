...
<hr>
<form name="itemform" action="add-item.php" method="get" onsubmit=
"return checkForm()" id="itemform">
<table>
<tr>
<td>Item Name:</td>
...
<tr>
<td>Item Quantity:</td>
<td><input type="text" size="5" name="quantity"></td>
</tr>
<tr>
<td>Item Category:</td>
<td><select name="cat_id"><?php
...
<tr>
<td></td>
<td><input type="submit" value="Add Item"><input type="reset"></td>
</tr>
</table>
</form>
<script language="JavaScript" type="text/javascript">
